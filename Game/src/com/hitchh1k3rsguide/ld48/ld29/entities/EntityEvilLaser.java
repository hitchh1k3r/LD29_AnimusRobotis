...
public class EntityEvilLaser extends AbstractEntity implements ComponentCollision,
        ComponentMovable, ComponentRenderable, ComponentUpkeep
{
    ...
    public EntityEvilLaser(long index, double x, double y, double angle, double speed, double offset)
    {
        super(index);
        if (sprite == null)
        {
            sprite = new Sprite("EvilLaser.png");
        }
        this.angle = angle;
